...
// source: https://github.com/vezwork/polylab/blob/main/dist/lib/math/Vec2.js
export const X = [1, 0];
export const Y = [0, 1];
export const UP = [0, -1];
...
export const scale = (v1, v2) => [v1[0] * v2[0], v1[1] * v2[1]];
...
export const rotateAround = (around) => (v, theta) =>
...
export const setAngle = (theta) => (v) =>
  mul(length(v), normalVec2FromAngle(theta));
export const setAngleFromVec = (angleVec) => (v) =>
